...
class DataApi {
	constructor(apiKey, options) {
		const requester = new _Requester2.default(apiKey, options);

		this.projects = new _Resource2.default('projects', requester, ['list', 'show', 'create', 'delete', 'update', 'copy']);
		this.medias = new _Resource2.default('medias', requester, ['list', 'show', 'update', 'delete', 'copy', 'stats']);
		this.account = new _Resource2.default('account', requester, ['list']);
		this.customizations = new _Resource2.default('customizations', requester, ['show', 'create', 'update', 'delete']);

		this.projectSharings = new _Resource2.default('projectSharings', requester, []);
	}
}
...
//          * @param Callback {any}
//          */
//         projectShow: function (project_hash_id) {
